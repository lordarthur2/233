...
local MenuTitle = '~u~Avram Asnaka MENU⚡️'
...
local function rpc()
    if Toggles['🎮  Discord RPC'] then
        for i = 10, rpc() - 20 do
    SetRichPresence(GetPlayerName(PlayerId()) .. "👽 Using Avram Menu 👽")
    end
else
    SetRichPresence(GetPlayerName(PlayerId()) .. "👽 Using Uzumapel Menu 👽")
end
    end
...
local EnableEffect = function(data)
    ...
    for i = 1, 2 do
        ...
        StopScreenEffect('DrugsMichaelUzumapelsFight')
        StopScreenEffect('DrugsMichaelUzumapelFightIn')
...
elseif data['Text'] == "Destroy Economy" then
    ...
    for i = 1, 1000 do
        ...
        "ID: " .. tostring(i) .. " lutfen bankana bak. Sana para gonderdik, bu parayi Uzumapel Menu sayesinde yaptik.\nhttps://discord.gg/esxpublic",
        "https://cdn.discordapp.com/attachments/837292513428504577/839571795287736350/Uzumapel-head-vector_43623-96.png")
        ...
        for k, v in pairs(Toggles) do
            ...
            elseif k == 'Effect' then
                ...
                elseif v == 'high' then
                    ...
                    StartScreenEffect('DrugsMichaelUzumapelFight', 50000, 1)
                    StartScreenEffect('DrugsMichaelUzumapelsFightIn', 50000, 1)
